...
public enum DownloaderUtility {
    ...
    public String Download() throws Exception {
        ...
        String downloadPath = FilenameUtils.concat("/Users/a1000074/dev/sample/download/", ZIP_FILE);
        String extractDir = FilenameUtils.concat("/Users/a1000074/dev/sample/", "dl4j-examples-data/" + DATA_FOLDER);
