...
public class Word2VecSentimentRNN {
    ...
    public static final String WORD_VECTORS_PATH = "/Users/a1000074/dev/temp/GoogleNews-vectors-negative300.bin.gz";
    ...
    public static void main0(String[] args) throws Exception {
        ...
        net.save(new File("/Users/a1000074/dev/model-temp/rnnNegPos.mdl"));
        ...
        try {
            ...
            System.out.println("Detected Invalid");
            e.printStackTrace();
        }
    ...
    public static void main(String ... v) {
        System.out.println("Test System .. " + System.currentTimeMillis());
        ...
        try {
            MultiLayerNetwork net = MultiLayerNetwork.load(new File("/Users/a1000074/dev/model-temp/rnnNegPos.mdl"), true) ;
            String comment = "Hated it with all my being. Worst movie ever. Mentally- scarred. Help me. It was that bad.TRUST ME!!!";

            WordVectors wordVectors = WordVectorSerializer.loadStaticModel(new File(WORD_VECTORS_PATH));

            SentimentExampleIterator test = new SentimentExampleIterator(DATA_PATH, wordVectors, batchSize, truncateReviewsToLength, false);
            INDArray features = test.loadFeaturesFromString(comment, 256);
            INDArray networkOutput = net.output(features);
            long timeSeriesLength = networkOutput.size(2);
            INDArray probabilitiesAtLastWord = networkOutput.get(NDArrayIndex.point(0), NDArrayIndex.all(), NDArrayIndex.point(timeSeriesLength - 1));
            ...
            comment = "I like this movie. The actor is the best point of this movie.";
            features = test.loadFeaturesFromString(comment, 256);
            ...
            System.out.println("--- Completed at " + (System.currentTimeMillis() - tp));
            ...
            tp = System.currentTimeMillis();
            comment = "I hate this movie. The actor is the worst point of this movie.";
            features = test.loadFeaturesFromString(comment, 256);
            networkOutput = net.output(features);
            timeSeriesLength = networkOutput.size(2);
            probabilitiesAtLastWord = networkOutput.get(NDArrayIndex.point(0), NDArrayIndex.all(), NDArrayIndex.point(timeSeriesLength - 1));
