...
public class CnnSentenceClassificationExample {
    ...
    public static final String DATA_PATH = FilenameUtils.concat("/Users/a1000074/dev/temp", "dl4j_w2vSentiment/");
    /** Location (local file system) for the Google News vectors. Set this manually. */
    private static final String WORD_VECTORS_PATH = "/Users/a1000074/dev/temp/GoogleNews-vectors-negative300.bin.gz";
    ...
    public static void main(String[] args) throws Exception {
        ...
        ComputationGraphConfiguration config = new NeuralNetConfiguration.Builder()
                ...
                .addLayer("out", new OutputLayer.Builder()
                        ...
                        .nOut(3)    //2 classes: positive or negative   // CHD
                        .build(), "globalPool")
                .setOutputs("out")
        ...
        net.save(new File("/Users/a1000074/dev/model-temp/cnnClass3.mdl"));
        ...
        System.out.println("\n\nPredictions for first negative review:\n" + contentsFirstNegative);
        for( int i=0; i<labels.size(); i++ ){
            System.out.println("P(" + labels.get(i) + ") = " + predictionsFirstNegative.getDouble(i));
        }

        System.out.println("Complted at " + (System.currentTimeMillis() - ts)) ;

        ts = System.currentTimeMillis() ;

        contentsFirstNegative = "Hated it with all my being. Worst movie ever. Mentally- scarred. Help me. It was that bad.TRUST ME!!!";
        featuresFirstNegative = ((CnnSentenceDataSetIterator)testIter).loadSingleSentence(contentsFirstNegative);
        ...
        ts = System.currentTimeMillis() ;
        contentsFirstNegative = "I like this movie. The actor is the best point of this movie.";
        featuresFirstNegative = ((CnnSentenceDataSetIterator)testIter).loadSingleSentence(contentsFirstNegative);
        predictionsFirstNegative = net.outputSingle(featuresFirstNegative);
        labels = testIter.getLabels();
    ...
    public static void main1(String ... v) {
        System.out.println("Active CNN Module ..");
        //Basic configuration
        int batchSize = 32;
        int truncateReviewsToLength = 256;  //Truncate reviews with length (# words) greater than this
        ...
        try {
            ...
            WordVectors wordVectors = WordVectorSerializer.loadStaticModel(new File(WORD_VECTORS_PATH));
//            DataSetIterator trainIter = getDataSetIterator(true, wordVectors, batchSize, truncateReviewsToLength, rng);
            DataSetIterator testIter = getDataSetIterator(true, wordVectors, batchSize, truncateReviewsToLength, rng);

            ComputationGraph net = ComputationGraph.load(new File("/Users/a1000074/dev/model-temp/cnnNegPos.mdl"), true) ;
            System.out.println("Load completed at " + (System.currentTimeMillis() - ts)) ;
            ...
            String contentsFirstNegative = FileUtils.readFileToString(new File(pathFirstNegativeFile), (Charset) null);
            INDArray featuresFirstNegative = ((CnnSentenceDataSetIterator)testIter).loadSingleSentence(contentsFirstNegative);
            System.out.println("FirstNegative -> " + featuresFirstNegative);
    ...
    private static DataSetIterator getDataSetIterator(boolean isTraining, WordVectors wordVectors, int minibatchSize,
        ...
        String negativeBaseDir2 = FilenameUtils.concat(path, "neg");    // CHD

        File filePositive = new File(positiveBaseDir);
        File fileNegative = new File(negativeBaseDir);
        File fileNega2 = new File(negativeBaseDir2);    // CHD
        ...
        reviewFilesMap.put("Nega2", Arrays.asList(Objects.requireNonNull(fileNega2.listFiles())));  // CHD
