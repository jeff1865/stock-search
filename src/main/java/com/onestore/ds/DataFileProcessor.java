...
//        processingOneColumnCsv2txt();
    ...
    public static void processLine2File() {
        File sentenceLinesFile = new File("/Users/a1000074/dev/data/comment_sample2/test/neg/fNeg.txt");
        ...
        try {
            ...
            while((line = br.readLine()) != null) {
                ...
                FileWriter fw = new FileWriter("/Users/a1000074/dev/data/comment_sample2/test/neg/sentence_" + lineNo++ + "");
                fw.write(line);
                fw.flush();
                fw.close();
            }
